...
const testAntiHotlinkExtra = async (path, expectObj, query) => {
    const app = (await import('@/app')).default;
...
const expectImgOrigin = async (query) => {
...
const expectImgProcessed = async (query) => {
...
const expectImgUrlencoded = async (query) => {
...
const expectMultimediaOrigin = async (query) => {
...
const expectMultimediaRelayed = async (query) => {
...
const expectMultimediaPartlyRelayed = async (query) => {
...
//# sourceMappingURL=anti-hotlink.test.js.map