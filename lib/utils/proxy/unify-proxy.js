...
export const unifyProxies = (proxyUris, proxyObj) => proxyUris.map((uri) => unifyProxy(uri, proxyObj)).filter((result) => result.proxyUri);
export default unifyProxy;
//# sourceMappingURL=unify-proxy.js.map